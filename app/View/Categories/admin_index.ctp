            ...
            <tbody>
                <?php foreach ($categories as $category): ?>
                    <tr>
                        ...
                        <td class="tableActs">                     
                            <?php echo $this->Crud->Imag('View', 'view', $category['Category']['id'], "&#xe081;"); ?>
                            <?php echo $this->Crud->Imag('Edit', 'edit', $category['Category']['id'], "&#xe1db;"); ?>
                            <?php echo $this->Crud->Imag('Delete', 'delete', $category['Category']['id'], "&#xe05d;", true); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
