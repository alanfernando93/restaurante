    ...
    <div class="col-sm-6 col-mod-6">
        <div class="row">
            <div class="col-sm-7 col-md-7">
                ...
                echo $this->Form->input('photo', array(
                    ...
                    'id' => 'photo',
                    'label' => 'Nueva Imagen',
                        //'name' => $this->request->data['Product']['photo']
                ));
                echo $this->Form->input('photo_dir', array(
                    'type' => 'hidden',
                        //'name' => $this->request->data['Product']['photo_dir']
                ));
                ?>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3 col-md-3">
                <?php
                echo $this->Form->label('', "Imagen Actual");
                echo $this->Html->image('../files/product/photo/' . $this->request->data['Product']['photo_dir'] . '/thumb_' . $this->request->data['Product']['photo']);
                ?>
            </div>
            <div class="col-sm-7 col-md-7 alert alert-danger">
                <p>
                    Nota :
                    Si no desea cambiar la imagen<br>
                    solo cancele la edicion del producto<br>
                </p> 
            </div>
        </div>
        <?php
