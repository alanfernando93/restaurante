...
<div id="contenedor">
    ...
    <div class="row-fluid" style="padding-bottom: 8px;">
        <?php echo $this->Crud->addNew(__('Add'), 'add', 'icon-plus-2'); ?>
    </div> 
            ...
            <tbody>
                <?php foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td class="tableActs">                     
                            <?php echo $this->Crud->Imag('View', 'view', $product['Product']['id'], "&#xe081;"); ?>
                            <?php echo $this->Crud->Imag('Edit', 'edit', $product['Product']['id'], "&#xe1db;"); ?>
                            <?php echo $this->Crud->Imag('Delete', 'delete', $product['Product']['id'], "&#xe05d;", true); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
