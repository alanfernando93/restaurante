...
/**
 * Syslog stream for Logging.
 * Writes logs to the system logger
 *
 * @package Cake.Log.Engine
 */
class SyslogLog extends BaseLog {
	...
	/**
	 * Extracts the call to openlog() in order to run unit tests on it.
	 * This function
	...
	/**
	 * Extracts the call to syslog() in order to run unit tests on it.
	 * This function
