...
abstract class AbstractPasswordHasher {
	 ...
	 * Settings passed from authenticator class to
	 ...
	 *        	Plain text password to hash or array of data
	...
	/**
	 * Check hash.
	 * Generate hash from user provided password string or data array
	 * and check against existing hash.
	 *
	 * @param string|array $password
	 *        	Plain text password to hash or data array.
	 * @param
	 *        	string Existing hashed password.
