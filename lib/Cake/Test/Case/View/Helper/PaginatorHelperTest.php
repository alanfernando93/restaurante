...
class PaginatorHelperTest extends CakeTestCase {
	...
	public function testSortLinks() {
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/param/sort:title/direction:asc' 
				),
				'Title',
				'/a' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/param/sort:date/direction:desc',
						'class' => 'asc' 
				),
				'Date',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/param/sort:title/direction:desc',
						'class' => 'asc' 
				),
				'descending',
				'/a' 
	...
	public function testSortLinkWithVirtualField() {
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/sort:Article.full_name/direction:desc',
						'class' => 'asc' 
				),
				'Article Full Name',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/sort:full_name/direction:desc',
						'class' => 'asc' 
				),
				'Full Name',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/sort:Article.full_name/direction:asc',
						'class' => 'desc' 
				),
				'Article Full Name',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/sort:full_name/direction:asc',
						'class' => 'desc' 
				),
				'Full Name',
				'/a' 
	...
	public function testSortLinksUsingDirectionOption() {
		...
		$expected = array (
				'a' => array (
						'href' => '/accounts/index/param/sort:title/direction:desc' 
				),
				'TestTitle',
				'/a' 
		);
	...
	public function testSortLinksUsingDotNotation() {
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/sort:Article.title/direction:asc',
						'class' => 'desc' 
				),
				'Article Title',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/sort:Article.title/direction:desc',
						'class' => 'asc' 
				),
				'Title',
				'/a' 
		...
		$expected = array (
				'a' => array (
						'href' => '/officespace/accounts/index/sort:title/direction:asc' 
				),
				'Title',
				'/a' 
		);
	...
	public function testSortAdminLinks() {
		...
		$expected = array (
				'a' => array (
						'href' => '/admin/test/index/param/sort:title/direction:asc' 
				),
				'Title',
				'/a' 
		);
		...
		$expected = array (
				'a' => array (
						'href' => '/admin/test/index/param/sort:Article.title/direction:asc' 
				),
				'Title',
				'/a' 
		);
	...
	public function testUrlGeneration() {
		...
		$expected = array (
				'a' => array (
						'href' => '/index/sort:controller/direction:asc' 
				),
				'Controller',
				'/a' 
		);
	...
	public function testPassedArgsMergingWithUrlOptions() {
		...
		$expected = array (
				'a' => array (
						'href' => '/articles/index/2/foo:bar/sort:title/direction:asc?x=y' 
				),
				'Title',
				'/a' 
		);
	...
	public function testPassedArgsMergingWithUrlOptionsParamTypeQuerystring() {
		...
		$expected = array (
				'a' => array (
						'href' => '/articles/index/2/foo:bar?x=y&amp;sort=title&amp;direction=asc' 
				),
				'Title',
				'/a' 
		);
	...
	public function testPagingLinks() {
		...
		$expected = array (
				...
				'a' => array (
						'href' => '/index/12/limit:10/foo:bar',
						'rel' => 'prev' 
				),
				'Prev',
				'/a',
	...
	public function testGenericLinksWithPresetOptions() {
		...
		$this->assertTags ( $result, array (
				'a' => array (
						'href' => '/index/sort:title/direction:desc' 
				),
				'Foo!',
				'/a' 
		) );
	...
	public function testNumbers() {
		...
		$expected = array (
				...
				array (
						'a' => array (
								'href' => '/index/sort:Client.name/direction:DESC' 
						) 
				),
				'1',
				'/a',
