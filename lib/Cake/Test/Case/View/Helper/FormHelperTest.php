...
class FormHelperTest extends CakeTestCase {
	...
	public function testInputMagicTypeDoesNotOverride() {
		...
		$result = $this->Form->input ( 'Model.user', array (
				'type' => 'checkbox' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testRadioLabelArray() {
		...
		$this->assertTextContains ( '<label for="ModelField1" class="checkbox float-left">Option A</label>', $result );
	}
	...
	public function testRadioWithCreate() {
		...
		$result = $this->Form->radio ( 'recipient', array (
				'1' => '1',
				'2' => '2',
				'3' => '3' 
		), array (
		...
		$this->assertTextNotContains ( '<label for="ModelModelRecipient1">1</label>', $result );
		$this->assertTextContains ( '<label for="ModelRecipient1">1</label>', $result );
	}
		...
		$expected = array (
				...
				array (
						'input' => array (
								...
								'name' => 'data[Model][multi_field][]',
								'value' => 'a+',
								'id' => 'ModelMultiFieldA2' 
						) 
				),
				array (
						'label' => array (
								'for' => 'ModelMultiFieldA2' 
						) 
				),
				'first',
				'/label',
				...
				array (
						'input' => array (
								...
								'name' => 'data[Model][multi_field][]',
								'value' => 'a++',
								'id' => 'ModelMultiFieldA1' 
						) 
				),
				array (
						'label' => array (
								'for' => 'ModelMultiFieldA1' 
						) 
				),
				'second',
				'/label',
		...
		$expected = array (
				...
				array (
						'input' => array (
								...
								'name' => 'data[Model][multi_field][]',
								'value' => 'a&gt;b',
								'id' => 'ModelMultiFieldAB2' 
						) 
				),
				array (
						'label' => array (
								'for' => 'ModelMultiFieldAB2' 
						) 
				),
				'first',
				'/label',
				...
				array (
						'input' => array (
								...
								'name' => 'data[Model][multi_field][]',
								'value' => 'a&lt;b',
								'id' => 'ModelMultiFieldAB1' 
						) 
				),
				array (
						'label' => array (
								'for' => 'ModelMultiFieldAB1' 
						) 
				),
				'second',
				'/label',
				...
				array (
						'input' => array (
								...
								'name' => 'data[Model][multi_field][]',
								'value' => 'a&quot;b',
								'id' => 'ModelMultiFieldAB' 
						) 
				),
				array (
						'label' => array (
								'for' => 'ModelMultiFieldAB' 
						) 
				),
				'third',
				'/label',
	...
	public function testPostLink() {
		...
		$result = $this->Form->postLink ( '', array (
				'controller' => 'items',
				'action' => 'delete',
				10 
		), array (
	...
	public function testPostLinkNestedData() {
		...
		$result = $this->Form->postLink ( 'Send', '/', array (
				'data' => $data 
		) );
		$this->assertContains ( '<input type="hidden" name="data[one][two][0]" value="3"', $result );
		$this->assertContains ( '<input type="hidden" name="data[one][two][1]" value="4"', $result );
	...
	public function testFormInputRequiredDetection() {
		...
		$result = $this->Form->input ( 'Contact.iamrequiredalways', array (
				'type' => 'file' 
		) );
		$expected = array (
				'div' => array (
	...
	public function testFormInputRequiredDetectionModelValidator() {
		ClassRegistry::getObject ( 'ContactTag' )->validator ()->add ( 'iwillberequired', 'required', array (
				'rule' => 'notEmpty' 
		) );
